...
var Modal=require('../Common/modal.jsx');var Facilities=React.createClass({displayName:"Facilities",render:function(){var data=this.props.data,facilitiesList=data.map(function(facility,index){return React.createElement("li",{key:index,className:"facilities__list__item"},React.createElement("i",{className:facility.class}),facility.name);}),modal={header:'Room Facilities',body:React.createElement("ul",{className:"facilities__list"},facilitiesList),buttons:null,id:'facilitiesModal'};return React.createElement("div",{className:"facilities"},React.createElement("ul",{className:"facilities__list clearfix"},facilitiesList.slice(0,5),React.createElement("li",{className:"facilities__list__all","data-toggle":"modal","data-target":"#facilitiesModal"},"View all Facilities")),React.createElement(Modal,{modal:modal}));}});module.exports=Facilities;}).call(this,require("g5I+bs"),typeof self!=="undefined"?self:typeof window!=="undefined"?window:{},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/components/Facilities/facilities.jsx","/components/Facilities");},{"../Common/modal.jsx":1,"buffer":11,"g5I+bs":41,"react":176}],3:[function(require,module,exports){(function(process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){'use strict';var React=require('react'); // Components
